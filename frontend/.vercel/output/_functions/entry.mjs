...
var middlewareSecret = "c8eb8bfc-fe99-4a76-95fd-137a6eff5600";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/blacklist.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/cars.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/rentals.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/renters.astro",
			"pathname": "/dashboard/renters",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_CamP0FQ1.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/blacklist_Co9tZKJc.mjs");
var _page2 = () => import("./chunks/cars_B7eBUbPC.mjs");
var _page3 = () => import("./chunks/rentals_BgezegFH.mjs");
var _page4 = () => import("./chunks/renters_0yirkCyy.mjs");
var _page5 = () => import("./chunks/dashboard_89iOKM-2.mjs");
var _page6 = () => import("./chunks/index_C__prAeF.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/dashboard/blacklist.astro", _page1],
	["src/pages/dashboard/cars.astro", _page2],
	["src/pages/dashboard/rentals.astro", _page3],
	["src/pages/dashboard/renters.astro", _page4],
	["src/pages/dashboard.astro", _page5],
	["src/pages/index.astro", _page6]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///C:/Users/Carl/Desktop/Personal%20Projects/RentSafe/frontend/","cacheDir":"file:///C:/Users/Carl/Desktop/Personal%20Projects/RentSafe/frontend/node_modules/.astro/","outDir":"file:///C:/Users/Carl/Desktop/Personal%20Projects/RentSafe/frontend/dist/","srcDir":"file:///C:/Users/Carl/Desktop/Personal%20Projects/RentSafe/frontend/src/","publicDir":"file:///C:/Users/Carl/Desktop/Personal%20Projects/RentSafe/frontend/public/","buildClientDir":"file:///C:/Users/Carl/Desktop/Personal%20Projects/RentSafe/frontend/dist/client/","buildServerDir":"file:///C:/Users/Carl/Desktop/Personal%20Projects/RentSafe/frontend/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/app.CNN29piI.css"}],"routeData":{"route":"/dashboard/blacklist","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/blacklist\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"blacklist","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/blacklist.astro","pathname":"/dashboard/blacklist","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/app.CNN29piI.css"},{"type":"external","src":"_astro/cars.BIK6kgoj.css"}],"routeData":{"route":"/dashboard/cars","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/cars\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"cars","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/cars.astro","pathname":"/dashboard/cars","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/app.CNN29piI.css"},{"type":"inline","content":":root{--bg:#f8fafc;--card:#fff;--muted:#64748b;--primary:#0f766e;--text:#0f172a;--border:#e2e8f0;--danger:#dc2626;--success:#16a34a}[data-astro-cid-qnjpmdyq]{box-sizing:border-box}body{background:var(--bg);color:var(--text);margin:0;font-family:Arial,sans-serif}.layout[data-astro-cid-qnjpmdyq]{grid-template-columns:240px 1fr;min-height:100vh;display:grid}.sidebar[data-astro-cid-qnjpmdyq]{color:#fff;background:#0f172a;height:100vh;padding:24px 18px;position:sticky;top:0}.brand[data-astro-cid-qnjpmdyq]{align-items:center;gap:10px;margin-bottom:24px;font-size:1.45rem;font-weight:700;display:flex}.logo[data-astro-cid-qnjpmdyq]{background:linear-gradient(135deg,#0f766e,#14b8a6);border-radius:10px;place-items:center;width:36px;height:36px;display:grid}nav[data-astro-cid-qnjpmdyq]{gap:10px;display:grid}nav[data-astro-cid-qnjpmdyq] a[data-astro-cid-qnjpmdyq]{color:#dbeafe;border-radius:10px;padding:12px 14px;text-decoration:none}nav[data-astro-cid-qnjpmdyq] a[data-astro-cid-qnjpmdyq]:hover,nav[data-astro-cid-qnjpmdyq] a[data-astro-cid-qnjpmdyq].is-active{background:#1e293b}.main[data-astro-cid-qnjpmdyq]{padding:24px}.topbar[data-astro-cid-qnjpmdyq]{justify-content:space-between;align-items:center;gap:12px;margin-bottom:20px;display:flex}.topbar-left[data-astro-cid-qnjpmdyq]{align-items:center;gap:12px;display:flex}.title[data-astro-cid-qnjpmdyq]{font-size:1.75rem;font-weight:700}.btn[data-astro-cid-qnjpmdyq]{cursor:pointer;border:0;border-radius:10px;padding:10px 14px;font-weight:700}.btn-primary[data-astro-cid-qnjpmdyq]{background:var(--primary);color:#fff}.btn-secondary[data-astro-cid-qnjpmdyq]{color:var(--text);background:#e2e8f0}.btn-danger[data-astro-cid-qnjpmdyq]{color:#fff;background:#ef4444}.card[data-astro-cid-qnjpmdyq]{background:var(--card);border:1px solid var(--border);border-radius:18px;padding:16px}form[data-astro-cid-qnjpmdyq]{gap:12px;display:grid}.two-col[data-astro-cid-qnjpmdyq]{grid-template-columns:1fr 1fr;gap:12px;display:grid}input[data-astro-cid-qnjpmdyq],select[data-astro-cid-qnjpmdyq]{border:1px solid var(--border);border-radius:10px;width:100%;padding:10px 12px;font-size:1rem}.warning[data-astro-cid-qnjpmdyq]{color:#9a5b00;background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;padding:12px}table[data-astro-cid-qnjpmdyq]{border-collapse:collapse;width:100%}th[data-astro-cid-qnjpmdyq],td[data-astro-cid-qnjpmdyq]{border-bottom:1px solid var(--border);text-align:left;padding:10px}.pill[data-astro-cid-qnjpmdyq]{color:#047857;background:#ecfdf5;border-radius:999px;padding:6px 10px;font-size:.75rem;display:inline-block}.muted[data-astro-cid-qnjpmdyq]{color:var(--muted)}.mobile-toggle[data-astro-cid-qnjpmdyq]{border:1px solid var(--border);color:var(--text);cursor:pointer;background:#fff;border-radius:10px;width:44px;height:44px;font-size:1.2rem;display:none}.sidebar-overlay[data-astro-cid-qnjpmdyq]{display:none}@media (width<=880px){.layout[data-astro-cid-qnjpmdyq]{grid-template-columns:1fr}.sidebar-overlay[data-astro-cid-qnjpmdyq]{opacity:0;pointer-events:none;z-index:30;background:#0f172a73;transition:opacity .2s;display:block;position:fixed;inset:0}.sidebar-overlay[data-astro-cid-qnjpmdyq].is-visible{opacity:1;pointer-events:auto}.sidebar[data-astro-cid-qnjpmdyq]{z-index:40;width:260px;height:100vh;transition:transform .2s;position:fixed;top:0;left:0;transform:translate(-110%)}.layout[data-astro-cid-qnjpmdyq].sidebar-open .sidebar[data-astro-cid-qnjpmdyq]{transform:translate(0)}.mobile-toggle[data-astro-cid-qnjpmdyq]{justify-content:center;align-items:center;display:inline-flex}}@media (width<=520px){.main[data-astro-cid-qnjpmdyq]{padding:16px}.topbar[data-astro-cid-qnjpmdyq]{flex-direction:column;align-items:flex-start}.two-col[data-astro-cid-qnjpmdyq]{grid-template-columns:1fr}}\n"}],"routeData":{"route":"/dashboard/rentals","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/rentals\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"rentals","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/rentals.astro","pathname":"/dashboard/rentals","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/app.CNN29piI.css"}],"routeData":{"route":"/dashboard/renters","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/renters\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"renters","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/renters.astro","pathname":"/dashboard/renters","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/app.CNN29piI.css"}],"routeData":{"route":"/dashboard","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard.astro","pathname":"/dashboard","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":":root{--card:#fff;--muted:#6d8180;--primary:#087f78;--primary-dark:#06665f;--danger:#c2413d;--text:#173333;--border:#dce7e5}[data-astro-cid-lcdefpme]{box-sizing:border-box}body{min-height:100vh;color:var(--text);background:#f4f7f8;place-items:center;margin:0;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;display:grid}.shell[data-astro-cid-lcdefpme]{width:min(100%,420px);padding:24px}.card[data-astro-cid-lcdefpme]{background:var(--card);border:1px solid var(--border);border-radius:12px;padding:30px 26px;box-shadow:0 16px 36px #15373614}.brand[data-astro-cid-lcdefpme]{align-items:center;gap:12px;margin-bottom:24px;display:flex}.logo[data-astro-cid-lcdefpme]{background:var(--primary);color:#fff;border-radius:10px;place-items:center;width:42px;height:42px;font-weight:700;display:grid}h1[data-astro-cid-lcdefpme]{margin:0;font-size:1.7rem}form[data-astro-cid-lcdefpme]{gap:14px;display:grid}label[data-astro-cid-lcdefpme]{gap:8px;font-size:.92rem;font-weight:600;display:grid}input[data-astro-cid-lcdefpme]{border:1px solid var(--border);border-radius:8px;width:100%;padding:12px 14px;font-size:1rem}input[data-astro-cid-lcdefpme]:focus{border-color:var(--primary);outline:none;box-shadow:0 0 0 3px #087f781f}.password-wrap[data-astro-cid-lcdefpme]{position:relative}.password-wrap[data-astro-cid-lcdefpme] input[data-astro-cid-lcdefpme]{padding-right:44px}.toggle-btn[data-astro-cid-lcdefpme]{cursor:pointer;color:var(--muted);background:0 0;border:0;font-weight:700;position:absolute;top:50%;right:10px;transform:translateY(-50%)}button[data-astro-cid-lcdefpme]{background:var(--primary);color:#fff;cursor:pointer;border:0;border-radius:8px;padding:13px 18px;font-weight:700}button[data-astro-cid-lcdefpme]:hover{background:var(--primary-dark)}.error[data-astro-cid-lcdefpme]{color:var(--danger);background:#fef2f2;border:1px solid #fecaca;border-radius:10px;padding:10px 12px;font-size:.9rem;display:none}.error[data-astro-cid-lcdefpme].visible{display:block}.helper[data-astro-cid-lcdefpme]{color:var(--muted);font-size:.82rem}.meta[data-astro-cid-lcdefpme]{text-align:center;color:var(--muted);margin-top:16px;font-size:.8rem}@media (width<=480px){.shell[data-astro-cid-lcdefpme]{padding:16px}.card[data-astro-cid-lcdefpme]{padding:20px 16px}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard/blacklist.astro",{"propagation":"none","containsHead":true}],["C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard/cars.astro",{"propagation":"none","containsHead":true}],["C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard.astro",{"propagation":"none","containsHead":true}],["C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard/rentals.astro",{"propagation":"none","containsHead":true}],["C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard/renters.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/dashboard/blacklist@_@astro":"chunks/blacklist_Co9tZKJc.mjs","\u0000virtual:astro:page:src/pages/dashboard/cars@_@astro":"chunks/cars_B7eBUbPC.mjs","\u0000virtual:astro:page:src/pages/dashboard@_@astro":"chunks/dashboard_89iOKM-2.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_CamP0FQ1.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_C__prAeF.mjs","\u0000virtual:astro:page:src/pages/dashboard/rentals@_@astro":"chunks/rentals_BgezegFH.mjs","\u0000virtual:astro:page:src/pages/dashboard/renters@_@astro":"chunks/renters_0yirkCyy.mjs","C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_BMTh0U5S.mjs","C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/components/DashboardShell.astro?astro&type=script&index=0&lang.ts":"_astro/DashboardShell.astro_astro_type_script_index_0_lang.BeAe89HG.js","C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard/blacklist.astro?astro&type=script&index=0&lang.ts":"_astro/blacklist.astro_astro_type_script_index_0_lang.BXba6Cbi.js","C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard/cars.astro?astro&type=script&index=0&lang.ts":"_astro/cars.astro_astro_type_script_index_0_lang.BO1hCmKF.js","C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard.astro?astro&type=script&index=0&lang.ts":"_astro/dashboard.astro_astro_type_script_index_0_lang.Cl_GkLnK.js","C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.CKRmPC5P.js","C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard/rentals.astro?astro&type=script&index=0&lang.ts":"_astro/rentals.astro_astro_type_script_index_0_lang.DlnO_uIY.js","C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/dashboard/renters.astro?astro&type=script&index=0&lang.ts":"_astro/renters.astro_astro_type_script_index_0_lang.CO90lH9u.js","C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/data/philippines-address.json":"_astro/philippines-address.iaZYZ8YD.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["C:/Users/Carl/Desktop/Personal Projects/RentSafe/frontend/src/pages/index.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`login-form`),t=document.getElementById(`login-error`),n=document.getElementById(`login-button`),r=document.getElementById(`password`),i=document.getElementById(`toggle-password`);i.addEventListener(`click`,()=>{let e=r.type===`password`;r.type=e?`text`:`password`,i.textContent=e?`Hide`:`Show`}),e.addEventListener(`submit`,async e=>{e.preventDefault(),t.textContent=``,t.classList.remove(`visible`),n.disabled=!0,n.textContent=`Logging in...`;try{let e=document.getElementById(`identifier`).value.trim(),t=r.value,n=await fetch(`https://rent-safe.onrender.com/api/auth/login`,{method:`POST`,credentials:`include`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({identifier:e,password:t})}),i=await n.json();if(!n.ok)throw Error(i.message||`Login failed`);window.location.href=`/dashboard`}catch(e){t.textContent=e.message,t.classList.add(`visible`)}finally{n.disabled=!1,n.textContent=`Log in`}});"]],"assets":["/favicon.ico","/favicon.svg","/_astro/blacklist.astro_astro_type_script_index_0_lang.BXba6Cbi.js","/_astro/cars.astro_astro_type_script_index_0_lang.BO1hCmKF.js","/_astro/dashboard.astro_astro_type_script_index_0_lang.Cl_GkLnK.js","/_astro/DashboardShell.astro_astro_type_script_index_0_lang.BeAe89HG.js","/_astro/pagination.BiouBCp5.js","/_astro/philippines-address.iaZYZ8YD.js","/_astro/rentals.astro_astro_type_script_index_0_lang.DlnO_uIY.js","/_astro/renters.astro_astro_type_script_index_0_lang.CO90lH9u.js","/_astro/sidebar.D53_C6Bj.js","/_astro/app.CNN29piI.css","/_astro/cars.BIK6kgoj.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"cO6ExyH3vCh/ZF4VPGspTf4d2mhKc8wNvAXNigd/lvI=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_API_URL": "https://rent-safe.onrender.com",
			"SITE": void 0,
			"SSR": true
		}, {
			OS: "Windows_NT",
			Path: "C:\\Users\\Carl\\Desktop\\Personal Projects\\RentSafe\\frontend\\node_modules\\.bin;C:\\Users\\Carl\\Desktop\\Personal Projects\\RentSafe\\node_modules\\.bin;C:\\Users\\Carl\\Desktop\\Personal Projects\\node_modules\\.bin;C:\\Users\\Carl\\Desktop\\node_modules\\.bin;C:\\Users\\Carl\\node_modules\\.bin;C:\\Users\\node_modules\\.bin;C:\\node_modules\\.bin;C:\\Program Files\\nodejs\\node_modules\\npm\\node_modules\\@npmcli\\run-script\\lib\\node-gyp-bin;c:\\Users\\Carl\\AppData\\Roaming\\Code\\User\\globalStorage\\github.copilot-chat\\debugCommand;c:\\Users\\Carl\\AppData\\Roaming\\Code\\User\\globalStorage\\github.copilot-chat\\copilotCli;C:\\Windows\\system32;C:\\Windows;C:\\Windows\\System32\\Wbem;C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\;C:\\Windows\\System32\\OpenSSH\\;C:\\Program Files (x86)\\NVIDIA Corporation\\PhysX\\Common;C:\\Program Files\\NVIDIA Corporation\\NVIDIA NvDLISR;C:\\Program Files\\nodejs\\;C:\\Program Files\\MongoDB\\Server\\8.2\\bin;C:\\Program Files\\Git\\cmd;C:\\Users\\Carl\\AppData\\Local\\Microsoft\\WindowsApps;C:\\Users\\Carl\\AppData\\Local\\Programs\\Microsoft VS Code\\bin;C:\\Users\\Carl\\AppData\\Roaming\\npm;C:\\Users\\Carl\\AppData\\Local\\Programs\\mongosh\\;C:\\Users\\Carl\\AppData\\Local\\Programs\\cursor\\resources\\app\\bin;C:\\Users\\Carl\\AppData\\Local\\Programs\\Antigravity\\bin"
		})?.PROD) return {
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "c8eb8bfc-fe99-4a76-95fd-137a6eff5600") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
